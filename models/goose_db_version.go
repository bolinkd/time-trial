...
var GooseDBVersionWhere = struct {
	...
	VersionID: whereHelperint64{field: `version_id`},
	IsApplied: whereHelperbool{field: `is_applied`},
	Tstamp:    whereHelpernull_Time{field: `tstamp`},
}
...
func (o *GooseDBVersion) UpsertG(updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	return o.Upsert(boil.GetDB(), updateOnConflict, conflictColumns, updateColumns, insertColumns)
}

// Upsert attempts an insert using an executor, and does an update or ignore on conflict.
// See boil.Columns documentation for how to properly use updateColumns and insertColumns.
func (o *GooseDBVersion) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
